...
Telar is one of the four open-source primitives AMPL develops with its partners, alongside the [Digitization Toolkit](/project/digitization-toolkit), which captures, [Fisqua](/project/fisqua), which catalogues, and [Zasqua](/project/zasqua), which publishes. Like the others, it can be used as part of a chain of tools — from digitisation to storytelling — or entirely independently.
